...
# Пять вузов бьют по пяти разным сайтам, поэтому греются параллельно: полный
# прогрев занимает время самого медленного, а не сумму. Число привязано к
# количеству вузов не для красоты: если поставить меньше, лишний вуз встанет
# в очередь за чужой сборкой в этом же пуле — и к его собственным секундам
# добавятся минуты ожидания ФА или СТАНКИНа.
MAX_PARALLEL_REFRESH = 5
