...
# ВАЖНО про ФА: оракул прогноза у него есть, а вот число мест — нет (fa.ru не
# публикует КЦП машинно), и 39 из 45 направлений живут на заглушке. Сверка
# прогноза там меряет каскад на заведомо кривых местах — читать её результат
# нужно с этой поправкой, см. seat_oracle.audit_fa.
PLACEMENT_VERIFIED_UNIVERSITIES = {"СТАНКИН", "МИРЭА", "МЭИ", "Финансовый университет"}
