...
# МИРЭА — minScore бюджетного конкурса из competitions_api (проходной балл,
# который сайт считает своим движком). МЭИ сюда не входит: там робот сам
# потребляет маркер «Зачисляется в другой КГ» с той же страницы, сверка была бы
# круговой. ФА не публикует проходных баллов по ходу приёма.
PLACEMENT_VERIFIED_UNIVERSITIES = {"СТАНКИН", "МИРЭА"}
